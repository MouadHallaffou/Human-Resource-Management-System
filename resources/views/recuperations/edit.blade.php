...
<div class="flex items-center justify-center min-h-screen bg-gray-900">
    <div class="bg-gray-800 shadow-md rounded-lg p-6 w-full max-w-5xl">
        <h1 class="text-3xl font-bold text-gray-100 mb-6 text-center">Modifier la demande de récupération</h1>
        ...
        <form action="{{ route('recuperations.update', $recuperation->id) }}" method="POST">
            ...
            <div class="mb-5">
                ...
                <input type="date" name="date_recuperation" id="date_recuperation" value="{{ old('date_recuperation', $recuperation->date_recuperation) }}"
            ...
            <div class="mb-5">
                ...
                <input type="number" name="jours_demandes" id="jours_demandes" value="{{ old('jours_demandes', $recuperation->jours_demandes) }}"
